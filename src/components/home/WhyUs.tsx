    ...
    <section aria-labelledby="home-why" className="container-x py-20 sm:py-24">
      ...
      <ul className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {items.map(({ icon: Icon, title, text }, i) => (
          <Reveal as="li" key={title} delay={i * 0.07} y={18} className="relative rounded-2xl p-6 text-center">
            <span className="relative mx-auto grid size-16 place-items-center">
              <span aria-hidden className="absolute inset-0 rounded-2xl bg-brand-400" />
